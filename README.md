...
4) Go to the Folder you extracted in step 2 and open a terminal there (Shift + Right Click on free Space -> Open cmd/powershell here or click on "run-server.bat").
